kf_mcmc <- function(MM, N = NULL, KK = NULL, TT,
                    y, yz = NULL,
                    Za, Zb, Zp, Zq,
  ...
  # run KF to obtain joint smoothing density
  ...
  # monitor_pgas_states(states_drawn = cbind(Xa[1, ], Xb[1, ],
  #                                          Xp[1, ], Xq[1, ]),
  #                     states_true  = cbind(xa_t, xb_t, xp_t, xq_t),
  #                     current = 1, total = MM, num_prints = num_plots_states)

  out_kf_jsd <- kf_jsd(y = y, yz =  NULL,
                       Za = Za, Zb = Zb, Zp = Zp, Zq = Zq,
                       #  Za_init = Za_init, Zb_init = Zb_init, Zp_init = Zp_init, Zq_init = Zq_init,
                       N = NULL, TT = TT, KK = NULL,
  ...
  for (m in 2:MM) {
    ...
    # monitor_pgas_states(states_drawn = cbind(Xa[m, ], Xb[m, ],
    #                                          Xp[m, ], Xq[m, ]),
    #                     states_true  = cbind(xa_t, xb_t, xp_t, xq_t),
    #                     current = m, total = MM, num_prints = num_plots_states)
